...
class CharacterDetector:
    ...
    def find_account_by_perceptual_hash(self, screenshot: np.ndarray,
        ...
        """
        try:
            from ...pkg.vision.perceptual_hash import find_similar_account
    ...
    def create_or_get_account_index(self, screenshot: np.ndarray) -> Tuple[int, str]:
        ...
        """
        from ...pkg.common.database import init_database, get_or_create_account, upsert_character
    ...
    def capture_first_slot_on_switch(self, screenshot: np.ndarray) -> Optional[str]:
        ...
        """
        from ...pkg.common.database import upsert_character
    ...
    def load_cached_characters(self, account_id: int) -> List[Dict[str, Any]]:
        ...
        """
        from ...pkg.common.database import list_characters_by_account
